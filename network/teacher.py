...
class ModalityFusionNetwork(nn.Module):
    def __init__(self, image_size, channels, patch_size=16, feature_dim=192, cross_attn_depth=1,
                 enc_depth=3, heads=3, pool='cls', dropout=0., emb_dropout=0.,num_class=104,
                 encoder_backbone='vit_base_patch16_224',checkpoint_path='weights/vit_base_patch16_224.npz'):
        super().__init__()
